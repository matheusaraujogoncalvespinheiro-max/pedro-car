    ...
    <div className="flex flex-col gap-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 bg-slate-50 border-emerald-100 border-b-4 border-b-emerald-500 group">
          ...
          <h4 className="text-3xl font-black text-emerald-600">R$ {stats.income.toFixed(2)}</h4>
        </Card>
        ...
        <Card className="p-6 bg-slate-50 border-red-100 border-b-4 border-b-red-600 group">
          ...
          <h4 className="text-3xl font-black text-red-600">R$ {stats.expense.toFixed(2)}</h4>
        </Card>
        ...
        <Card className="p-6 bg-black text-white shadow-xl shadow-black/20 group">
          ...
          <h4 className="text-3xl font-black text-white">R$ {stats.balance.toFixed(2)}</h4>
        </Card>
      </div>
